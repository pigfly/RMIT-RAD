...
[1, 10] in /Users/alex/environment/sample_app/app/controllers/users_controller.rb
...
### Section 7.1.4
1. The code in listing `7.12` does correctly manipulate the size of the image based on the keyword argument.
2. The code in listing `7.13` is confirmed to be able to be used in place of the code in listing `7.12`.
...
### Section 7.3.3
1. Change the min password length to 5 updates the error message to read: `Password is too short (minimum is 5 characters)`.
...
=> #<User id: 2, name: "Alex Jiang", email: "alex.jiang@g.com", created_at: "2018-01-21 21:06:43", updated_at: "2018-01-21 21:06:43", password_digest: "$2a$10$7jQSCRZ4z8h0eBRnqWYk5.8r4ZFzUKuYvFylU/gxCVt...">
>> user.attributes                                                         
